...
namespace UserManagement.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [HttpGet]
        public async Task<ActionResult<IEnumerable<User>>> GetUseUserManagementsync()
        {
            return await _usersService.GetUseUserManagementsync();
        }
        ...
        {
            var users = await _usersService.GetUseUserManagementsync();
